...
- ✅ **Login e Cadastro:** Autenticação segura integrada ao backend.
- ✅ **Lista de Pets:** Visualização rápida do status (Online/Offline) e nível de bateria.
- ✅ **Rastreamento em Tempo Real:** Integração com Google Maps para mostrar a localização exata.
- ✅ **Gerenciamento de Pets:** Adicionar novos pets com foto (integração com câmera/galeria) e upload para o servidor.
- ✅ **Alertas:** Visualização de notificações de bateria fraca ou saída de cerca virtual.
...
1. **Backend Rodando:** O servidor [Patatag Web](https://github.com/flaypy/patatag_web) deve estar rodando na mesma rede (Wi-Fi)
2. **Android Studio:** Versão Ladybug ou superior recomendada.
3. **Chave de API do Google Maps:** Uma chave válida com a "Maps SDK for Android" ativada.

### Passo a Passo

1. **Clonar o repositório**
   ```bash
   git clone [https://github.com/lucaspaiolog/patatag_app.git]

2. **Configurar o Endereço do Servidor** 

O app precisa saber onde está o seu backend Python/Flask para fazer as requisições.
...
Infelizmente, eu não consigo gerar um arquivo direto para download (como um link clicável).

No entanto, preparei o conteúdo completo do arquivo README.md abaixo. Você pode clicar no botão "Copiar código" no canto superior direito do bloco, colar em um bloco de notas e salvar como README.md.

Aqui está o arquivo completo e formatado:

Markdown

# 🐾 PATATAG App - Monitoramento Mobile

Aplicativo Android nativo para o sistema **Patatag**, permitindo o rastreamento GPS de pets em tempo real, visualização de histórico e gerenciamento de dispositivos diretamente pelo smartphone.

> Este projeto faz parte do Trabalho de Conclusão de Curso (TCC) em Desenvolvimento de Software Multiplataforma na Fatec Praia Grande.
...
| Tela de Login | Lista de Pets | Mapa em Tempo Real | Adicionar Pet |
|:---:|:---:|:---:|:---:|
| <img src="docs/login.png" width="200" alt="Login" /> | <img src="docs/home.png" width="200" alt="Home" /> | <img src="docs/mapa.png" width="200" alt="Mapa" /> | <img src="docs/add_pet.png" width="200" alt="Add Pet" /> |

*(Nota: Adicione as imagens correspondentes na pasta `docs` do seu repositório)*
